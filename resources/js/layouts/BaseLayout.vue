      ...
      <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
        ...
        <div v-if="!isAuthenticated" class="hidden lg:flex lg:flex-1 lg:justify-end">
          <router-link :to="{ name: 'login' }">
            <a class="text-sm font-semibold leading-6 text-gray-900">Sign in</a>
          </router-link>
        </div>
        <div v-if="isAuthenticated" class="hidden lg:flex lg:flex-1 lg:justify-end" @click="signOut()">
          <a href="#" class="text-sm font-semibold leading-6 text-gray-900">Sign out</a>
        </div>
      </nav>
          ...
          <div class="mt-6 flow-root">
            <div class="-my-6 divide-y divide-gray-500/10">
              ...
              <div class="py-6">
                ...
                <div v-if="isAuthenticated">
                  <a href="/login" class="-mx-3 block rounded-lg px-3 py-2.5 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50">Sign out</a>
                </div>
              </div>
            </div>
          </div>
